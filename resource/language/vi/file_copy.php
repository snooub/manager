<?php
    ...
    return [
        ...
        'alert' => [
            'cancel_copy_directory_failed'                    => 'Hủy duyệt đường dẫn sao chép thư mục <strong>{$filename}</strong> thất bại, hãy thử lại',
            'cancel_copy_file_failed'                         => 'Hủy duyệt đường dẫn sao chép tập tin <strong>{$filename}</strong> thất bại, hãy thử lại',
            'cancel_move_directory_failed'                    => 'Hủy duyệt đường dẫn di chuyển thư mục <strong>{$filename}</strong> thất bại, hãy thử lại',
            'cancel_move_file_failed'                         => 'Hủy duyệt đường dẫn di chuyển tập tin <strong>{$filename}</strong> thất bại, hãy thử lại',
            'cancel_copy_directory_success'                   => 'Hủy duyệt đường dẫn sao chép thư mục <strong>{$filename}</strong> thành công',
            'cancel_copy_file_success'                        => 'Hủy duyệt đường dẫn sao chép tập tin <strong>{$filename}</strong> thành công',
            'cancel_move_directory_success'                   => 'Hủy duyệt đường dẫn di chuyển thư mục <strong>{$filename}</strong> thành công',
            'cancel_move_file_success'                        => 'Hủy duyệt đường dẫn di chuyển tập tin <strong>{$filename}</strong> thành công',
