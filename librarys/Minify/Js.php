<?php
    ...
    class JS extends Minify
    {
        ...
        public function __construct()
        {
            ...
            $dataDir = env('app.path.data_javascript');
            $options = FILE_IGNORE_NEW_LINES | FILE_SKIP_EMPTY_LINES;

            $this->keywordsReserved = FileInfo::fileReadsToArray($dataDir . SP . 'keywords_reserved.txt', $options);
            $this->keywordsBefore   = FileInfo::fileReadsToArray($dataDir . SP . 'keywords_before.txt', $options);
            $this->keywordsAfter    = FileInfo::fileReadsToArray($dataDir . SP . 'keywords_after.txt', $options);
            $this->operators        = FileInfo::fileReadsToArray($dataDir . SP . 'operators.txt', $options);
            $this->operatorsBefore  = FileInfo::fileReadsToArray($dataDir . SP . 'operators_before.txt', $options);
            $this->operatorsAfter   = FileInfo::fileReadsToArray($dataDir . SP . 'operators_after.txt', $options);
        }
